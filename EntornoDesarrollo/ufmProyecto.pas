...
var
  fmProyecto: TfmProyecto;

implementation

{$R *.dfm}

uses udmEntorno, uEntornoDesarrollo;
...
procedure TfmProyecto.btAgregarClick(Sender: TObject);
var
  Item: TListItem;
begin
...
procedure TfmProyecto.btQuitarClick(Sender: TObject);
var
  Item: TListItem;
  aux: Integer;
begin
...
procedure TfmProyecto.cambiarIdioma(Sender: TObject);
var
  aux: TStrings;
begin
...
function TfmProyecto.Execute(esNuevo: boolean= false): TModalResult;
var
...
procedure TfmProyecto.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
...
procedure TfmProyecto.guardarValor(Sender: TObject; var AllowChange: Boolean);
begin
  intGuardarValor;
end;

procedure TfmProyecto.intGuardarValor;
var
  aux: TStrings;
begin
  aux := TStringlist.Create;
...
procedure TfmProyecto.lvIdiomasDisponiblesDragDrop(Sender, Source: TObject; X, 
        Y: Integer);
begin
  btQuitarClick(nil);
end;

procedure TfmProyecto.lvIdiomasProyectoDragDrop(Sender, Source: TObject; X, Y: 
        Integer);
begin
  btAgregarClick(nil);
end;

procedure TfmProyecto.lvIdiomasProyectoDragOver(Sender, Source: TObject; X, Y: 
        Integer; State: TDragState; var Accept: Boolean);
begin
  Accept := (Source is TListView);
end;

procedure TfmProyecto.PageControl1Change(Sender: TObject);
var
  i: Integer;
begin
